...
- Hay 3 servicios asociados a Kinesis:
	...
	Firehouse: Carga de Streams hacia S3, Redshift, ElasticSearch, Splunk...
...
- Keyword para el examen: Traces, Debbuging, Distributed application
